...
export const products: Record<string, Product[]> = {
  ...
  "3d-acrylic": [
    P("Acrylic Photo Frame", 899, "/products/3d-acrylic/acrylic-photo-frame.webp"),
    P("Family Photo Frame", 999, "/products/3d-acrylic/family-photo-frame.webp"),
    P("Classic Photo Frame", 699, "/products/3d-acrylic/classic-photo-frame.webp"),
    P("Wedding Frame", 1499, "/products/3d-acrylic/wedding-frame.webp"),
    P("Collage Frame", 1199, "/products/3d-acrylic/collage-frame.webp"),
    P("Mosaic Photo Frame", 1299, "/products/3d-acrylic/mosaic-photo-frame.webp"),
],
  "visiting-cards": [
 ...
 trophies: [
   P("Ring Award Trophy", 1499, "/products/trophies/trophy-certificate-achievement.webp"),
    P("Ring Award Trophy", 1499, "/products/trophies/trophy-excellence-set-three copy.webp"),
     P("Ring Award Trophy", 1499, "/products/trophies/trophy-gold-leaf-twist copy.webp"),
      P("Ring Award Trophy", 1499, "/products/trophies/trophy-gold-star-swirl copy.webp"),
 P("Ring Award Trophy", 1499, "/products/trophies/trophy-ring-billboard-award copy.webp"),
